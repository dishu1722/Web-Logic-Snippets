...
<?php
/**
 * CarePantry: Bulletproof Combined Clean Shipping Methods for Cart & Checkout
 */
...
function custom_carepantry_shipping_labels( $label, $method ) {
    ...
    if ( strpos( $title, 'T1' ) !== false || $method_id === 'flat_rate:1' || round($cost_val, 2) === 25.50 ) {
        $clean_title = 'Zimbabwe Delivery Zone T1';
        ...
        $clean_title = 'Zimbabwe Delivery Zone T2';
        ...
        $clean_title = 'Zimbabwe Delivery Zone T3';
